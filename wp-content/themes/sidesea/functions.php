...
function h5bs_primary_nav() {
    wp_nav_menu(array(
        ...
        'menu_class'      => 'menu align-center sticky-shrinknav-menu',         // custom class
...
function h5bs_mobile_nav() {
    wp_nav_menu(array(
        ...
        'menu_id'         => 'overlay-nav-menu',                 // custom id
        'menu_class'      => 'overlay-nav-menu',       // custom class
...
// START - Al Mansy Balangue Theme

// Setup About me Settings

// function about_settings_add_menu() {
// 	add_menu_page( 'About Settings', 'About Settings', 'manage_options', 'about-settings', 'about_settings_page', null, 99 );
// }
// add_action( 'admin_menu', 'about_settings_add_menu' );
require_once( 'includes/about-options.php' );
